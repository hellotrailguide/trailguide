...
Identical to [`useTrailManager`](/api/use-trail-manager) — see that page for the full options reference.

## Return value

Identical to [`useTrailManager`](/api/use-trail-manager) — see that page for the full return value reference.

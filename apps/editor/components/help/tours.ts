...
export const EDITOR_TOUR: Trail = {
  ...
  steps: [
    ...
    },
    {
      ...
      content: "Don't forget to save! Your trails are stored locally and can be synced to GitHub or GitLab.",
    ...
    },
    {
      id: 'sync',
      title: 'Sync with Git',
      content: 'Push your trails to GitHub or GitLab as JSON files. Review changes in PRs and MRs just like code.',
  ...
  steps: [
    {
      id: 'settings-account',
      title: 'Your Account',
      content: 'Manage your email, connected GitHub or GitLab account, and sign-out from here.',
    ...
    },
    {
      ...
      content: 'Upgrade to Pro to unlock Git sync (GitHub & GitLab), the analytics dashboard, and selector auto-repair. Your first 14 days are free.',
